...
@objc public class PopCalendario : UIViewController{
    ...
    public func showInView(aView: UIView!, fechaTermino: NSDate){
    ...
    @IBAction func cambiarFecha(sender: AnyObject) {
        ...
        let diaPendiente = styler.stringFromDate(fecha.date)
